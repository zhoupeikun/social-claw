...
Claw 是一个数字分身系统，通过分析用户历史社交媒体数据（微博、即刻等），提炼人格特征，生成符合用户风格的内容，并在即刻平台实现自动化运营。

### 核心能力

- **人格建模**：基于 5960 条微博数据，构建工作/生活双模式人格
- **内容生成**：接入 DeepSeek API，生成符合用户风格的内容
- **自动运营**：Playwright 浏览器自动化，实现登录、发帖、互动
- **隐私保护**：明确的隐私边界和脱敏规则

### 项目背景

- **用户**: [@PrettyHugo](https://weibo.com/prettyhugo) - 腾讯前产品，14 年微博用户
